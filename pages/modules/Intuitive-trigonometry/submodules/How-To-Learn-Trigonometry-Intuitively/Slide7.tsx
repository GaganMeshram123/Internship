      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-300 dark:border-slate-700 shadow-md h-full">
          ...
          <div className="space-y-4 text-lg text-slate-600 dark:text-slate-400">
            <p>Imagine your neighbor builds a tall wall right next to your house. We can use this to understand two more important trig functions: <strong>Tangent</strong> and <strong>Secant</strong>.</p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-400 dark:border-blue-700 rounded-lg px-6 py-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>Imagine a <strong>Unit Circle</strong> with its center at your house.</li>
                <li>The "wall" is a vertical line at <InlineMath>x = 1</InlineMath>.</li>
                ...
                <li><strong>Secant (<InlineMath>\sec\theta</InlineMath>):</strong> This is the <strong>length of the "ladder"</strong> from your house to that point on the wall.</li>
              </ul>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-300 dark:border-slate-700 shadow-md h-full flex flex-col items-center">
            ...
            <div className="grid grid-cols-3 gap-2 text-center mb-6 p-4 bg-slate-100 dark:bg-slate-900/50 rounded-lg w-full">
                ...
                <div>
                    <p className="text-sm font-medium text-slate-500"><InlineMath>\tan\theta</InlineMath> (Wall Height)</p>
                    <p className="text-xl font-bold font-mono text-blue-600 dark:text-blue-400">
                        {isAsymptote ? 'Undefined' : tanValue.toFixed(2)}
                    </p>
                </div>
                 <div>
                    <p className="text-sm font-medium text-slate-500"><InlineMath>\sec\theta</InlineMath> (Ladder Length)</p>
                    <p className="text-xl font-bold font-mono text-blue-600 dark:text-blue-400">
                        {isAsymptote ? 'Undefined' : secValue.toFixed(2)}
                    </p>
                </div>
            </div>
            <input
