...
export default function ReflectionsSlide2() {
  ...
  const slideInteractions: Interaction[] = [
    {
      ...
      conceptName: 'Determining Reflections (Axis)',
      type: 'judging',
      description: 'Testing finding reflection lines (x-axis, y-axis)'
    }
  ];
  ...
  const questions: QuizQuestion[] = [
    {
      ...
      explanation: "Correct! The x-coordinate (2) stayed the same, but the y-coordinate (3) flipped its sign to (-3). This is a 'flip' over the x-axis."
    },
    {
      ...
      explanation: "Correct! The y-coordinate (1) stayed the same, but the x-coordinate (-4) flipped its sign to (4). This is a 'flip' over the y-axis. (The line $x=0$ is another name for the y-axis!)"
    }
  ];
  ...
  const slideContent = (
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 transition-colors duration-300">
      <div className="grid grid-cols-2 gap-8 p-8 mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-100 dark:bg-slate-700">
              <p className="text-lg font-mono text-center font-bold">Rule: $(x, y) \to (x, -y)$</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            <h3 className="text-xl font-semibold mb-4 text-blue-600 dark:text-blue-400 text-center">Reflecting over an Axis</h3>
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Point+P(3,2)+reflecting+over+x-axis+and+y-axis"
                alt="A coordinate plane showing P(3,2) reflecting to P'(3,-2) over the x-axis, and to P''(-3,2) over the y-axis"
                className="max-w-full h-auto rounded-lg shadow-md"
                style={{ width: '100%', maxWidth: '500px', height: 'auto' }}
              />
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-4 text-center">
              Reflecting $P(3, 2)$ over the x-axis gives $(3, -2)$. Reflecting over the y-axis gives $(-3, 2)$.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            {!isQuizComplete ? (
              ...
              <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-8">
                <div className="text-3xl mb-4">Mirror, Mirror...</div>
                <div className="text-xl font-semibold mb-2 text-blue-600 dark:text-blue-400">Quiz Complete!</div>
                <div className="text-lg text-slate-600 dark:text-slate-400">
                  You scored {score} out of {questions.length}
                </div>
                <div className="text-lg text-slate-600 dark:text-slate-400 mt-2">
                  {score === questions.length ? 'You\'ve got the axis rules down!' : 'Great job!'}
                </div>
              </motion.div>
            )}
          </div>
  ...
  return (
    <SlideComponentWrapper 
      slideId="determining-reflections"
