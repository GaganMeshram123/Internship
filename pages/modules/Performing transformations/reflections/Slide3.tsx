...
export default function ReflectionsSlide3() {
  ...
  const questions: QuizQuestion[] = [
    ...
    },
    {
      ...
      correctAnswer: 'The line $y = -x$',
      explanation: "Correct! The coordinates $(x, y)$ swapped places AND flipped their signs, becoming $(-y, -x)$. $(-3, 1) \to (-1, -(-3)) \to (-1, 3)$. This is the rule for reflecting over $y = -x$."
    }
  ];
  ...
  const slideContent = (
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 transition-colors duration-300">
      <div className="grid grid-cols-2 gap-8 p-8 mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-100 dark:bg-slate-700">
              <p className="text-lg font-mono text-center font-bold">Rule: $(x, y) \to (y, x)$</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            <h3 className="text-xl font-semibold mb-4 text-blue-600 dark:text-blue-400 text-center">Reflecting over $y = x$</h3>
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Point+P(1,4)+reflecting+over+y=x+to+P'(4,1)"
                alt="A coordinate plane showing the line y=x, with point P(1,4) reflecting over it to point P'(4,1)"
                className="max-w-full h-auto rounded-lg shadow-md"
                style={{ width: '100%', maxWidth: '500px', height: 'auto' }}
              />
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-4 text-center">
              Reflecting $P(1, 4)$ over the line $y = x$ gives $P'(4, 1)$.
            </p>
          </div>
