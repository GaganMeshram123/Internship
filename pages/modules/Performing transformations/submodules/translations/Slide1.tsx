  ...
  const questions: QuizQuestion[] = [
    {
      ...
      question: "How would you translate the point $P(3, 5)$ using the rule $(x, y) \to (x - 2, y + 4)$?",
      options: [
        "$P'(1, 9)$",
        "$P'(5, 9)$",
        "$P'(1, 1)$",
    ...
    },
    {
      ...
      question: "What does the translation vector $\langle -5, 0 \rangle$ mean?",
      options: [
        'Move 5 units left and 0 units up/down',
        'Move 5 units right and 0 units up/down',
        'Move 0 units left/right and 5 units up',
        'Move 0 units left/right and 5 units down'
      ],
      correctAnswer: 'Move 5 units left and 0 units up/down',
      explanation: "Correct! The first number ($a$) is the horizontal change (negative is left). The second number ($b$) is the vertical change."
    }
  ];
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-100 dark:bg-slate-700">
              <p className="text-lg font-mono text-center">$(x, y) \to (x + a, y + b)$</p>
            </div>
            <p className="text-lg leading-relaxed mt-4">
              <strong>Example:</strong> $(x, y) \to (x + 3, y - 1)$ means "move 3 units right, and 1 unit down."
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-100 dark:bg-slate-700">
              <p className="text-lg font-mono text-center">$\langle a, b \rangle$</p>
            </div>
            <p className="text-lg leading-relaxed mt-4">
              <strong>Example:</strong> $\langle 3, -1 \rangle$ means "move 3 units right, and 1 unit down."
            </p>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-4 text-center">
              The point $P(2, 1)$ translated by $\langle 3, -1 \rangle$ becomes $P'(2+3, 1-1)$, which is $P'(5, 0)$.
            </p>
          </div>
