          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <ul className="mt-4 space-y-3 text-lg">
              ...
              <li className="flex items-start">
                ...
                <span>Apply the translation rule to *each vertex* to find the new coordinates ($A', B', C'$).</span>
              </li>
              <li className="flex items-start">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Show+A,B,C+moving+to+A',B',C'"
                alt="A coordinate plane showing a triangle ABC, with vector arrows pointing from A to A', B to B', and C to C', forming a new triangle A'B'C'"
