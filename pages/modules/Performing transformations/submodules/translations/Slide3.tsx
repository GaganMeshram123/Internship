...
export default function TranslationsSlide3() {
  ...
  const questions: QuizQuestion[] = [
    {
      id: 'find-rule-graph-q1',
      question: "Look at the graph. The blue triangle (pre-image) is translated to the green triangle (image). What is the translation vector?",
      options: [
        "$\langle -6, -3 \rangle$",
        "$\langle 6, 3 \rangle$",
        "$\langle 3, 6 \rangle$",
      ...
      correctAnswer: "$\langle -6, -3 \rangle$",
      explanation: "Correct! If you pick a vertex, like the top one at (3, 2), it moves to (-3, -1). This is 6 units left ($-6$) and 3 units down ($-3$)."
    }
  ];
      ...
      <div className="grid grid-cols-2 gap-8 p-8 mx-auto">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <p className="text-lg leading-relaxed mt-4">
              <strong>Step 4:</strong> Write your rule as $\langle a, b \rangle$.
            </p>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Pre-image+at+(3,2)+Image+at+(-3,-1)"
                alt="A coordinate plane showing a blue triangle (pre-image) and a green triangle (image). An arrow shows the translation from (3,2) to (-3,-1)."
                className="max-w-full h-auto rounded-lg shadow-md"
                style={{ width: '100%', maxWidth: '500px', height: 'auto' }}
              />
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-4 text-center">
              From the top vertex, we count 6 units LEFT ($-6$) and 3 units DOWN ($-3$). The rule is $\langle -6, -3 \rangle$.
            </p>
          </div>
