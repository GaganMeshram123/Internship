          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <ul className="mt-4 space-y-3 text-lg">
              <li className="flex items-start">
                ...
                <span><strong>Angle:</strong> Formed by two <strong>rays</strong> that share a common endpoint (called the vertex).</span>
              </li>
              <li className="flex items-start">
                <span className="font-bold text-emerald-500 mr-2">||</span>
                <span><strong>Parallel Lines:</strong> Two <strong>lines</strong> on a <strong>plane</strong> that never meet.</span>
              </li>
              <li className="flex items-start">
                <span className="font-bold text-emerald-500 mr-2">⊥</span>
                <span><strong>Perpendicular Lines:</strong> Two <strong>lines</strong> that intersect at a perfect $90^\circ$ <strong>angle</strong>.</span>
              </li>
              <li className="flex items-start">
                <span className="font-bold text-emerald-500 mr-2">Polygon:</span>
                <span><strong>Polygon:</strong> A closed shape on a <strong>plane</strong> made of straight <strong>line segments</strong>. (e.g., triangles, squares)</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Angle,+Parallel,+Perpendicular"
                alt="A diagram showing an angle, two parallel lines, and two perpendicular lines"
                className="max-w-full h-auto rounded-lg shadow-md"
                style={{ width: '100%', maxWidth: '500px', height: 'auto' }}
              />
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-4 text-center">
              An angle (∠), parallel lines (||), and perpendicular lines (⊥) are all built from lines and rays.
            </p>
          </div>
