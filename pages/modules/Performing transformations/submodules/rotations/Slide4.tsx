  ...
  const questions: QuizQuestion[] = [
    {
      ...
      question: "To rotate a triangle $\triangle XYZ$ $90^\circ$ around the origin, what is the process?",
      options: [
        'Find the center of the triangle and rotate that one point.',
        'Rotate point X, then guess where Y and Z go.',
        "Apply the $90^\circ$ rule $(x, y) \to (-y, x)$ to all three vertices, $X, Y, \text{and } Z$.",
        'Flip the triangle over the y-axis.'
      ],
      correctAnswer: "Apply the $90^\circ$ rule $(x, y) \to (-y, x)$ to all three vertices, $X, Y, \text{and } Z$.",
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <ul className="mt-4 space-y-3 text-lg">
              ...
              <li className="flex items-start">
                ...
                <span>Apply the chosen rotation rule (like $(x, y) \to (-y, x)$) to *each vertex* to find the new coordinates ($A', B', C'$).</span>
              </li>
              <li className="flex items-start">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Show+A,B,C+rotating+to+A',B',C'"
                alt="A coordinate plane showing a triangle ABC rotating, with arcs from A to A', B to B', and C to C', forming a new triangle A'B'C'"
