  ...
  const questions: QuizQuestion[] = [
    {
      ...
      explanation: "Correct! The whole point of a translation is to change the location! Everything else (size, shape, and orientation) stays exactly the same."
    }
  ];
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <p className="text-lg leading-relaxed">
              Let's summarize everything we know about translations. A translation is a **rigid transformation** (or isometry).
            </p>
            <p className="text-lg leading-relaxed mt-4">
              This means the image is **congruent** ($\cong$) to the pre-image.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
           ...
           <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            <h3 className="text-xl font-semibold mb-4 text-red-600 dark:text-red-400">What Changes?</h3>
            <ul className="mt-4 space-y-2 text-lg">
              <li className="flex items-start">
                <span className="font-bold text-red-500 mr-2">✗</span>
                <span><strong>Location:</strong> The position of the shape on the plane changes (unless the vector is $\langle 0, 0 \rangle$!).</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Identical+shapes+in+new+location"
                alt="A blue F-shape being translated to a new position, showing it is still an F-shape and not flipped or turned"
