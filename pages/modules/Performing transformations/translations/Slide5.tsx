  ...
  const questions: QuizQuestion[] = [
    {
      ...
      question: "Triangle $\triangle ABC$ has a vertex $C$ at $(4, -1)$. What are the coordinates of the new vertex $C'$ after a translation of $\langle -5, 3 \rangle$?",
      options: [
        "$C'(-1, 2)$",
        "$C'(9, 2)$",
        "$C'(-1, -4)$",
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <div className="flex justify-center">
              <img 
                src="https://via.placeholder.com/500x300.png?text=Triangle+ABC+translated+by+%3C-5,+3%3E"
                alt="A coordinate plane showing blue triangle ABC being translated 5 left and 3 up to become green triangle A'B'C'"
