...
export default function PlantLifeCycleSlide2() {
  ...
  const slideInteractions: Interaction[] = [
    {
      id: 'plant-lifecycle-stages-quiz',
      conceptId: 'plant-lifecycle-understanding',
      conceptName: 'Plant Life Cycle Stages Quiz',
      type: 'judging',
      description: 'Testing understanding of pollination and fertilization'
    }
  ];
  ...
  const questions: QuizQuestion[] = [
    {
      id: 'pollination-question',
      question: 'The process where pollen is carried from the anther to the stigma is called what?',
      options: [
        'Germination',
        'Fertilization',
        'Pollination',
      ...
      explanation: 'Correct! Pollination is the process where pollen is carried from the anther (male part) to the stigma (female part) of a flower.'
    },
    {
  ...
  const handleQuizAnswer = (answerText: string) => {
    ...
    handleInteractionComplete({
      interactionId: `plant-lifecycle-stages-quiz-q${currentQuestionIndex + 1}-${current.id}-${Date.now()}`,
      value: answerText,
      isCorrect,
      timestamp: Date.now(),
      conceptId: 'plant-lifecycle-understanding',
            ...
            {!isQuizComplete ? (
              ...
              <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-8">
                ...
                <div className="text-lg text-slate-600 dark:text-slate-400 mt-2">
                  {score === questions.length ? 'Brilliant! 🌸' : 'Great job! 👏'}
                </div>
              </motion.div>
            )}
          </div>
  ...
  return (
    <SlideComponentWrapper 
      slideId="plant-life-cycle-stages"
      slideTitle="Key Stages: Pollination & Fertilization"
