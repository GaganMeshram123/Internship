...
export default function PlantLifeCycleSlide3() {
  ...
  const slideInteractions: Interaction[] = [
    {
      id: 'plant-lifecycle-final-quiz',
      conceptId: 'plant-lifecycle-understanding',
      conceptName: 'Plant Life Cycle Final Quiz',
      type: 'judging',
      description: 'Testing understanding of seed dispersal and germination'
    }
  ];
  ...
  const questions: QuizQuestion[] = [
    {
      id: 'dispersal-question',
      question: 'Why do seeds need to be dispersed or spread out?',
      options: [
        'To make them easier for animals to find',
        'So they can grow with less competition from each other',
        'To help them change color',
        'So they can all grow in one spot'
      ],
    ...
    },
    {
      ...
      question: 'What is the stage that starts the life cycle all over again?',
      options: [
        'Pollination',
        'Fertilization',
        'Flowering',
      ...
      explanation: 'Exactly! Germination is when the seed starts to grow in a new, suitable place, beginning the life cycle once more.'
    }
  ];
  ...
  const handleQuizAnswer = (answerText: string) => {
    ...
    handleInteractionComplete({
      interactionId: `plant-lifecycle-final-quiz-q${currentQuestionIndex + 1}-${current.id}-${Date.now()}`,
      value: answerText,
      isCorrect,
      timestamp: Date.now(),
      conceptId: 'plant-lifecycle-understanding',
            ...
            {!isQuizComplete ? (
              ...
              <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-8">
                ...
                <div className="text-lg text-slate-600 dark:text-slate-400 mt-2">
                  {score === questions.length ? 'You\'ve mastered the life cycle! 🌟' : 'Great job! 👏'}
                </div>
              </motion.div>
            )}
          </div>
  ...
  return (
    <SlideComponentWrapper 
      slideId="plant-life-cycle-final-stages"
      slideTitle="Final Stages: Germination & Dispersal"
