...
export default function SssSlide1() {
  ...
  const slideInteractions: Interaction[] = [
    {
      id: 'sss-intro-quiz',
      conceptId: 'sss-criterion-intro',
      conceptName: 'SSS Criterion Introduction',
      type: 'judging',
      description: 'Testing understanding of the SSS criterion components'
    }
  ];
  ...
  const questions: QuizQuestion[] = [
    {
      id: 'sss-intro-q1-meaning',
      question: 'What does the "SSS" criterion stand for?',
      options: [
        "Side-Angle-Side",
        "Angle-Side-Side",
        "Side-Side-Side",
      ...
      explanation: "Correct! SSS stands for Side-Side-Side. It means all three corresponding sides are congruent."
    },
    {
      id: 'sss-intro-q2-requirement',
      question: 'To use SSS, how many pairs of congruent parts do you need to know?',
      options: [
        "3 pairs of sides and 3 pairs of angles",
        "3 pairs of sides",
        "2 pairs of sides and 1 pair of angles",
        "3 pairs of angles"
      ],
      correctAnswer: "3 pairs of sides",
      explanation: "Exactly! The power of SSS is that you *only* need to know that the three pairs of corresponding sides are congruent. The angles will then automatically match."
    }
  ];
  ...
  const handleQuizAnswer = (answerText: string) => {
    ...
    handleInteractionComplete({
      interactionId: `sss-intro-quiz-q${currentQuestionIndex + 1}-${current.id}-${Date.now()}`,
      value: answerText,
      isCorrect,
      timestamp: Date.now(),
      conceptId: 'sss-criterion-intro',
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-4 text-center">
              If Side 1, Side 2, and Side 3 all match, the triangles must be congruent.
            </p>
          </div>
  ...
  return (
    <SlideComponentWrapper
      slideId="sss-introduction"
      slideTitle="Introduction to the SSS Criterion"
      moduleId="congruence"
