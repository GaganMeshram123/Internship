        ...
        <AnimatePresence>
          {questionIndex === 0 && (
            ...
            >
              ...
              {/* Question Parts */}
              <text x={T1_Q1.A.x + 20} y={T1_Q1.A.y + 35} fill={questionColor} fontSize="14" fontWeight="bold">AC = ?</text>
              <text x={T2_Q1.D.x - 50} y={T2_Q1.D.y + 35} fill={strokeColor} fontSize="14" fontWeight="bold">DF = 25</text>
            </motion.g>
          )}
          ...
          {questionIndex === 1 && (
            ...
            >
              ...
              {/* Question Parts */}
              <text x={T1_Q2.B.x + 10} y={T1_Q2.B.y + 15} fill={questionColor} fontSize="14" fontWeight="bold">BC = 3x - 5</text>
              <text x={T2_Q2.E.x + 10} y={T2_Q2.E.y + 15} fill={strokeColor} fontSize="14" fontWeight="bold">EF = 16</text>
            </motion.g>
          )}
        </AnimatePresence>
      </svg>
...
export default function AasSlide4() {
  ...
  const questions: QuizQuestion[] = [
    {
      id: 'aas-find-length-q1',
      question: 'The triangles are congruent by AAS. What is the length of side $AC$?',
      options: [
        "25",
        "We can't tell the length of $AC$",
        "The length is equal to $AB$"
      ],
      correctAnswer: "25",
      explanation: "Correct! The triangles are congruent by AAS. By CPCTC, $AC \cong DF$. Since $DF = 25$, the length of $AC$ must also be 25."
    },
    {
      id: 'aas-find-length-q2',
      question: 'The triangles are congruent by AAS. What is the length of side $BC$?',
      options: [
        "7",
        "16",
        "21",
        "We need to know $x$ first"
      ],
      correctAnswer: "16",
      explanation: "Correct! The triangles are congruent by AAS. By CPCTC, $BC \cong EF$. Since $EF = 16$, the length of $BC$ must also be 16. (You could solve $3x - 5 = 16$ to find $x=7$, but the length is simply 16)."
    }
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            <h2 className="text-2xl font-bold mb-4 text-blue-600 dark:text-blue-400">Finding Lengths with AAS</h2>
            <p className="text-lg leading-relaxed">
              The <strong>CPCTC</strong> rule is universal. It doesn't just apply to angles; it applies to <strong>sides</strong> as well.
            </p>
            <p className="text-lg leading-relaxed mt-4">
              If you can prove two triangles are congruent by AAS, you automatically know that all three pairs of corresponding sides are also congruent.
            </p>
          </div>

          {/* --- CARD 2 (CPCTC for Sides) --- */}
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
            <h3 className="text-xl font-semibold mb-4 text-blue-600 dark:text-blue-400">The Process</h3>
            <p className="text-lg leading-relaxed">
            ...
            <ul className="mt-4 space-y-3 text-lg">
              <li className="flex items-start">
                ...
                <span>Confirm the triangles are congruent by <strong>AAS</strong>.</span>
              </li>
              <li className="flex items-start">
                <span className="font-bold text-blue-500 mr-2">2. Use CPCTC:</span>
                <span>Find the corresponding side on the other triangle.</span>
              </li>
              <li className="flex items-start">
                <span className="font-bold text-blue-500 mr-2">3. State the Length:</span>
                <span>The lengths must be equal. If $EF = 16$, then $BC$ must also be 16.</span>
              </li>
            </ul>
             <div className="mt-4 p-4 rounded-lg bg-slate-100 dark:bg-slate-700">
              <p className="text-lg">
                <strong>Tip:</strong> Sometimes a question will give you an algebraic expression (like $3x-5$) but only ask for the length. The length is simply the value of its corresponding partner (16)!
              </p>
            </div>
          </div>
        </div>
                    ...
                    const className = `w-full p-3 rounded-lg text-left transition-all border-2 ${
                      selected
                        ? showFeedback
                          ...
                          : 'border-blue-500 bg-blue-50 dark:bg-blue-900/3D' // Selected
