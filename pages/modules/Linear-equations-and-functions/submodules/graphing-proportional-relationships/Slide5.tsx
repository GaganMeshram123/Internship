...
export default function GraphingProportionalAssessment({ questions }: Props) {
    const [localInteractions, setLocalInteractions] = useState<Record<string, InteractionResponse>>({});
    
    const slideInteractions: Interaction[] = questions ? questions.map((q: Question) => ({...q, conceptId: 'graphing-proportional-assessment', conceptName: 'Proportional Relationships Assessment', type: q.inputType})) : [];
    ...
    return (
        ...
        >
            ...
            {slideInteractions.length > 0 ? (
                <TrackedInteraction 
                    interaction={slideInteractions[0]} // Now this is safe
