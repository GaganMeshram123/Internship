...
export default function GraphingProportionalAssessment({ questions }) {
    const [localInteractions, setLocalInteractions] = useState<Record<string, InteractionResponse>>({});
    const slideInteractions: Interaction[] = questions ? questions.map(q => ({...q, conceptId: 'graphing-proportional-assessment', conceptName: 'Proportional Relationships Assessment', type: 'question'})) : [];
