...
export default function SolutionsToLinearEquationsAssessment({ questions }) {
    const [localInteractions, setLocalInteractions] = useState<Record<string, InteractionResponse>>({});
    const slideInteractions: Interaction[] = questions ? questions.map(q => ({...q, conceptId: 'solutions-to-linear-equations-assessment', conceptName: 'Solutions to Linear Equations Assessment', type: 'question'})) : [];
