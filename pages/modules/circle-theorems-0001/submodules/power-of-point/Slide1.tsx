...
export default function PowerOfPointSlide1() {
  ...
  // Using line from P through the direction point
  ...
  // Calculate two intersection points with circle for first secant
  ...
  // Calculate two intersection points with circle for second secant
